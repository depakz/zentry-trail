"""
SensitiveFileValidator — probes for exposed sensitive files and admin paths.
Acts on paths the crawler discovered (signal_bag endpoints) and common
locations like /admin/clients.xls, /v2/swagger.json, /admin/admin.jsp.
"""
