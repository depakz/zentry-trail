...
from modules import recon, probe, discovery
# New modules
from modules import param_miner, smart_filter, fuzzer, exploiter
from modules import nuclei_scanner, response_analyzer, validator, reporter
