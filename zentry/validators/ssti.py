...
# AdaptiveExploitEngine removed (dead code from core/)
class AdaptiveExploitEngine:
    def __init__(self, *a, **kw): pass
    def get_next_payload(self, *a, **kw): return None
    def record_result(self, *a, **kw): pass
def compute_reward(*a, **kw): return 0.0
from .registry import register
def suggest_payloads(*a, **kw): return []  # stub: local_payload_engine removed
