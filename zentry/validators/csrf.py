...
from zentry.session import FactCategory, FactStore, Evidence, ExecutionContext, ValidationResult
...
class CSRFValidator(BaseValidator):
    ...
    def __init__(self, session=None, evidence_store=None, context: Optional[ExecutionContext] = None, auth_manager=None):
        super().__init__(session=session, evidence_store=evidence_store, context=context, auth_manager=auth_manager)
