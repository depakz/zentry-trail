...
from zentry.session import FactCategory, FactStore
...
_ENDPOINT_HINTS = [
    ...
    "/redeem",
    "/claim",
    # From smart_filter AUTH
    "/logon",
    "/sso",
    "/oauth",
    "/register",
    "/signup",
    # From smart_filter PASSWORD
    "/password",
    "/reset",
    "/forgot",
    "/recover",
    # From smart_filter API
    "/v1",
    "/v2",
    "/rest",
    # From smart_filter ADMIN
    "/manager",
    "/panel",
    "/console",
    # From smart_filter UPLOAD
    "/file",
]
