...
from .tool_wrappers import _run_binary as run_cmd
import logging
logger = logging.getLogger('zentry.recon')
NUCLEI_RATE = 150
NUCLEI_BATCH_SIZE = 25
def resolve_binary(name): import shutil; return shutil.which(name) or name
